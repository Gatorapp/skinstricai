...
const DiamondBackground = () => {
  ...
  return (
    <>
      ...
      ></div>
      <div 
        className="hidden lg:block absolute w-[550px] h-[550px] border-2 border-[--primary] border-dotted opacity-20"
        style={{ transform: `rotate(${diamondRotations[1]}deg)` }}
      ></div>
      <div
        className="hidden lg:block absolute w-[600px] h-[600px] border-2 border-[--primary] border-dotted opacity-10"
